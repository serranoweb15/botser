...
import { makeStyles, useTheme } from "@material-ui/core/styles"; // Add this line
...
import LiveHelpIcon from '@material-ui/icons/LiveHelp';  //ChatGPT
import MailOutlineIcon from "@material-ui/icons/MailOutline"; //Email
import SendIcon from "@material-ui/icons/Send"; //Email
import ScheduleIcon from "@material-ui/icons/Schedule"; //Email
import LoyaltyRounded from "@material-ui/icons/LoyaltyRounded";
...
const MainListItems = (props) => {
  ...
  useEffect(() => {
      ...
      if (!user.id) return;
        ...
        const campaignsEnabled = data
          ? data.filter(s => s.key === "campaignsEnabled" && s.value?.toLowerCase() === 'true').length > 0
          : false;

				setShowCampaigns(campaignsEnabled);
			} catch (err) {
				toastError(err);
			}
		};
...
<ListItem
        ...
        className={openEmailSubmenu ? classes.icon : ''} // Adicione esta linha
      >
      ...
      <Collapse in={openEmailSubmenu} timeout="auto" unmountOnExit>
        <List component="div" disablePadding>
          ...
          >
            <ListItemIcon className={openEmailSubmenu ? classes.icon : ''}>
              <SendIcon />
            </ListItemIcon>
            ...
            {showCampaigns && (
              <React.Fragment>
                <ListItem
                  ...
                  className={openCampaignSubmenu ? classes.icon : ''}
                >
                  <ListItemIcon className={classes.icon}>
                    <EventAvailableIcon />
                  </ListItemIcon>
                ...
                >
                  <List component="div" disablePadding>
                    <ListItem onClick={() => history.push("/campaigns")} button>
                      <ListItemIcon className={openCampaignSubmenu ? classes.icon : ''}>
                        <ListIcon />
                      </ListItemIcon>
