    ...
    translations: {
      ...
      userModal: {
        ...
        form: {
          ...
          password: "Senha",
          profile: "Perfil",
          campaignEnable: "Habilitar Campanhas?",
          maxCampaigns: "Max Campanhas",
          maxContactsPerCampaign: "Max contatos/campanha",
      ...
      ticketsManager: {
        buttons: {
          newTicket: "Novo Ticket",  // botão novo ticket atendimento
        },
      },
      ticketsQueueSelect: { //filtro de conversas
        placeholder: "Filas",
      },
      tickets: {
        toasts: {
      ...
      campaigns: {
        ...
        dialog: {
          new: "Nova Campanha de {{name}}",
          update: "Editar Campanha de {{name}}",
          readonly: "Campanha Apenas Visualização de {{name}}",
          form: {
            queue: "Fila",
            name: "Nome",
            maxCampaigns: "Max Campanhas",
      ...
      backendErrors: {
        ...
        ERR_WAPP_GREETING_REQUIRED:
          ...
          ERR_CAMPAIGN_REQUIRED:
          "Faltam dados obrigatórios a serem preenchidos na campanha.",
