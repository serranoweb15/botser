...
import openAiRoutes from "./openAiRoutes";  //ChatGpt
import calendarRoutes from "./calendarRoutes"; //calendar
import taskRoutes from "./taskRoutes"; // Tarefas
...
routes.use(openAiRoutes); //Chatgpt
routes.use(calendarRoutes); //Calendar
routes.use(taskRoutes); //tarefas
